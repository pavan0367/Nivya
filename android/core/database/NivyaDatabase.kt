...
/**
 * Room Database caching family links, device telemetry, battery offline queue, network queue, usage stats, location, device health, safety alerts, and live activity.
 */
@Database(
    entities = [
        FamilyEntity::class,

...
@SpringBootTest(properties = {"nivya.email.verification-required=true"})
...
public class EmailAndSessionIntegrationTest {
    ...
    void testEmailProviders() {
        ...
        assertThat(brevoEmailProvider.getProviderName()).isEqualTo("BREVO");
        ...
        assertThat(emailProviderFactory.getProvider("BREVO")).isNotNull();
